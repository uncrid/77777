...
summon potion ~ ~1 ~ {Tags:["in.alchemist_potion","in.air_toggle"],NoGravity:1b,Glowing:0b,Motion:[0.0,0.0,0.0],Item:{id:"minecraft:splash_potion",count:1b,components:{potion_contents:{potion:'minecraft:weakness'}}}}
