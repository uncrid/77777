...
summon small_fireball ~ ~4 ~ {Tags:["in.inferno_entity", "in.shulker"],Motion:[0.5,0.0,0.0],acceleration_power:[0.0,0.0,-0.05]}
summon small_fireball ~ ~4 ~ {Tags:["in.inferno_entity", "in.shulker"],Motion:[-0.5,0.0,0.0],acceleration_power:[0.0,0.0,0.05]}
summon small_fireball ~ ~4 ~ {Tags:["in.inferno_entity", "in.shulker"],Motion:[0.0,0.0,0.5],acceleration_power:[0.05,0.0,0.0]}
summon small_fireball ~ ~4 ~ {Tags:["in.inferno_entity", "in.shulker"],Motion:[0.0,0.0,-0.5],acceleration_power:[-0.05,0.0,0.0]}
