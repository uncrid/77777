...
execute if score $health in.inferno matches 120.. as @e[type=shulker_bullet,tag=in.shulker,predicate=incendium:random/10] at @s run summon fireball ~ ~-0.25 ~ {Motion:[0.0,0.0,0.0],acceleration_power:[0.0,-0.07,0.0]}
