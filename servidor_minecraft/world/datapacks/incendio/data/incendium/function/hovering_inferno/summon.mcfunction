...
execute at @e[type=marker,tag=in.altar,distance=..4] run summon blaze ~ ~4 ~ {attributes: [{base: 700.0d, id: "minecraft:generic.max_health"}, {base: 20.0d, id: "minecraft:generic.armor"}, {base: 0.87d, id: "minecraft:generic.knockback_resistance"}, {base: 20.0d, id: "minecraft:generic.attack_knockback"}, {base: 12.0d, id: "minecraft:generic.armor_toughness"}, {base: 0.4d, id: "minecraft:generic.movement_speed"}, {base: 20.0d, id: "minecraft:generic.attack_damage"}, {base: 70.0d, id: "minecraft:generic.follow_range"}], PersistenceRequired: 1b, Tags: ["in.hovering_inferno"], Health: 700.0f, Rotation: [-129.48582f, 0.0f], HandItems: [{id:"totem_of_undying",count:1b}, {}], CustomName: '{"translate":"incendium.admin.menu.inferno","fallback":"Hovering Inferno", "color": "#ff6600"}', CanPickUpLoot: 0b, DeathLootTable:"incendium:hovering_inferno"}
