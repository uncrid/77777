...
execute at @s run summon minecraft:ghast ~ ~ ~ {Invulnerable:true,attributes:[{base:0.1d, id:"generic.scale"}],Tags:["in.baby_ghast"],Passengers:[{id:"minecraft:allay",Tags:["in.baby_head"]}]}
