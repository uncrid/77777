...
execute positioned ^ ^ ^0.2 unless block ~ ~ ~ #incendium:airs run summon minecraft:firework_rocket ~ ~0.2 ~ {Silent:1b,Motion:[0.0,-0.2,0.0],ShotAtAngle:1,LifeTime:0,FireworksItem:{id:"firework_rocket",count:1,components:{fireworks:{flight_duration:1,explosions:[{shape:'burst',has_twinkle:false,has_trail:false,colors:[I;16725028]},{shape:'burst',has_twinkle:false,has_trail:false,colors:[I;16733476]},{shape:'burst',has_twinkle:false,has_trail:false,colors:[I;16742692]},{shape:'burst',has_twinkle:false,has_trail:false,colors:[I;16751908]}]}}},Tags:["in.firestorm_firework"]}
