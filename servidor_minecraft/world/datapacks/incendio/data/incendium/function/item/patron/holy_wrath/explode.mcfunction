...
summon minecraft:firework_rocket ~ ~0.1 ~ {Silent:1b,Motion:[0.0,0.0,0.0],ShotAtAngle:true,LifeTime:0,FireworksItem:{id:"firework_rocket",count:1,components:{fireworks:{flight_duration:1,explosions:[{shape:'star',has_twinkle:false,has_trail:false,colors:[I;16777215]},{shape:'star',has_twinkle:false,has_trail:false,colors:[I;16777175]},{shape:'star',has_twinkle:false,has_trail:false,colors:[I;16777139]},{shape:'star',has_twinkle:false,has_trail:false,colors:[I;16777099]},{shape:'star',has_twinkle:false,has_trail:false,colors:[I;16777074]},{shape:'star',has_twinkle:false,has_trail:false,colors:[I;16777041]}]}}}}
