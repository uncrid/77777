...
summon minecraft:firework_rocket ~ ~0.1 ~ {Silent:1b,Motion:[0.0,0.0,0.0],ShotAtAngle:1,LifeTime:0,FireworksItem:{id:"firework_rocket",count:1,components:{fireworks:{flight_duration:1,explosions:[{shape:'large_ball',has_twinkle:false,has_trail:false,colors:[I;65535]},{shape:'large_ball',has_twinkle:false,has_trail:false,colors:[I;51455]},{shape:'large_ball',has_twinkle:false,has_trail:false,colors:[I;38655]},{shape:'large_ball',has_twinkle:false,has_trail:false,colors:[I;25855]},{shape:'large_ball',has_twinkle:false,has_trail:false,colors:[I;13055]},{shape:'large_ball',has_twinkle:false,has_trail:false,colors:[I;255]}]}}},Tags:["in.sentrys_wrath_firework"]}
