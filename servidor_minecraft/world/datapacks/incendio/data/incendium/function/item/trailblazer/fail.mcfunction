...
summon small_fireball ~ ~1.25 ~ {Motion:[0.0d,-0.9d,0.0d],acceleration_power:[0.0d, -0.1d, 0.0d]}
execute anchored eyes run summon small_fireball ^ ^0.25 ^0.5 {Motion:[0.0d,-0.9d,0.0d],acceleration_power:[0.0d, -0.1d, 0.0d]}
execute anchored eyes run summon small_fireball ^ ^0.25 ^-0.5 {Motion:[0.0d,-0.9d,0.0d],acceleration_power:[0.0d, -0.1d, 0.0d]}
execute anchored eyes run summon small_fireball ^0.5 ^0.25 ^ {Motion:[0.0d,-0.9d,0.0d],acceleration_power:[0.0d, -0.1d, 0.0d]}
execute anchored eyes run summon small_fireball ^-0.5 ^0.25 ^ {Motion:[0.0d,-0.9d,0.0d],acceleration_power:[0.0d, -0.1d, 0.0d]}
