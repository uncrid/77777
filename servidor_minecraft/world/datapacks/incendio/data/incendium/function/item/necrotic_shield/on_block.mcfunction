...
summon area_effect_cloud ~ ~0.25 ~ {id:"minecraft:area_effect_cloud",ReapplicationDelay:200,Radius:0.5f,RadiusPerTick:0.8f,Duration:8,potion_contents:{potion:'minecraft:water',custom_effects:[{"id":"minecraft:wither",amplifier:2,duration:100}],Tags:["in.necrotic_wither"]}}
summon area_effect_cloud ~ ~0.25 ~ {id:"minecraft:area_effect_cloud",Particle:{type:large_smoke},ReapplicationDelay:200,Radius:0.5f,RadiusPerTick:0.8f,Duration:10}
summon area_effect_cloud ~ ~0.25 ~ {id:"minecraft:area_effect_cloud",Particle:{type:raid_omen},ReapplicationDelay:200,Radius:0.5f,RadiusPerTick:0.8f,Duration:10}
