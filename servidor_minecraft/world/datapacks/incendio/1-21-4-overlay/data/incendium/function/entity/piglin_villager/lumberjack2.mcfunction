...
data modify entity @s ArmorItems set value [{}, {count:1b, id:"minecraft:iron_leggings", components:{damage:0}}, {}, {}]
data modify entity @s HandItems set value [{count:1b, id:"minecraft:iron_axe", components:{damage:0}}, {}]
